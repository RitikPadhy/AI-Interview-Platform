...
import {getRandomInterviewCover} from "@/lib/utils";    // Gets a random cover photo
...
const InterviewCard = ({ interviewId, userId, role, type, techstack, createdAt }: InterviewCardProps) => {
    ...
    // Gives the current time if the feedback is created, or from the index.t.s or using the current data, and then formatting it
